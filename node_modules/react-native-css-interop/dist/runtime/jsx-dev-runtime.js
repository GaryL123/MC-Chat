...
function jsx(type, props, ...args) {
    ...
    return require("./components/rendering").render(jsx_dev_runtime_1.default.jsx, type, props, ...args);
}
exports.jsx = jsx;
function jsxs(type, props, ...args) {
    ...
    return require("./components/rendering").render(jsx_dev_runtime_1.default.jsxs, type, props, ...args);
}
exports.jsxs = jsxs;
function jsxDEV(type, props, ...args) {
    ...
    return require("./components/rendering").render(jsx_dev_runtime_1.default.jsxDEV, type, props, ...args);
}
